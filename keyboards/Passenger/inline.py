...
def inline_choose_selected_route_markup() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    return builder.button(text='<', callback_data='r_prev').button(text='>', callback_data='r_next') \
        .button(text="<-", callback_data='return_main').adjust(2, 1).as_markup(resize_keyboard=True)
